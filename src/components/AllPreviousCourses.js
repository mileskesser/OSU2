...
function AllPreviousCourses(props) {
    const navigate = useNavigate();

    const [listHeight, setListHeight] = useState(window.innerHeight - 220);
    ...
    return (
        <div className='prev-course-container'>
            ...
            <div className='term-selector'>
                    <button onClick={(e)=>navigate('/ViewPreviousCourses')}>Back</button>
                </div>
            <div className='prev-course-list' style={{height: listHeight}}>
                {prevCourseList.map((item)=>{
                    return (
                        <div className='prev-course'>
                            ...
                            <div className='prev-box-row'>
                                <div className='prev-box-column'>
                                    <span><strong>{"Term: "}</strong>{termList[item.termId].termName}</span>
...
export default AllPreviousCourses
